      ...
      <LayoutMarginCenter>
        ...
        <ul className="grid grid-cols-1 gap-5 m-2 xsm:grid-cols-2 xs:grid-cols-3 lg:grid-cols-4">
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/poster">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/cartucheras">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/libretas">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/cojines">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/cojinesMid">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/medias">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/tazas">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
          ...
          <li className="w-full h-fit rounded-xl shadow-md  bg-blanco-cool xsm:overflow-hidden">
            <Link prefetch={false} className="flex p-5 xsm:p-0 xsm:block" href="bts/polos">
              <div className="w-full overflow-hidden rounded-full shadow-lg xsm:shadow-none xsm:rounded-none">
