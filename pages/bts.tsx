...
console.log('btsCategories', btsCategories)
  return (
    <div>
      ...
      <h3 className="text-gray-500 text-center font-medium tracking-wider text-3xl capitalize my-20 mx-5">Porque Sabemos Que Eres Fan De BTS Hemos Decidido Abrir Una Tienda Especial Para Todos Los Army</h3>
      <div className="">
